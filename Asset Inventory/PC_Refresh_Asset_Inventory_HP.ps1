#=========================================================================================
# INSTRUCTIONS
# -This script is called on by executing the PC_Refresh_Asset_Inventory.ps1 script.
# -This was originally created to identify HP computers but can be configured for any
#  new model replacing another model. Simply change "HP" to the correct model.
#=========================================================================================
# FileName: PC_Refresh_Asset_Inventory_HP.ps1
# Created: 02/21/2017
# Updated: 09/17/2017
# Tech: Matthew Messer
# Email: mmesserlmt@gmail.com
#=========================================================================================
# Purpose: Export computer asset information to the "HP" sheet in the "PC_Refresh_Asset_Inventory" Excel Workbook
