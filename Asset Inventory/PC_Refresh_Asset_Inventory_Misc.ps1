...
# -This was originally created to identify miscellaneous devices (i.e. MS Surface).
#=========================================================================================
# FileName: PC_Refresh_Asset_Inventory_Misc.ps1
# Created: 02/21/2017
# Updated: 09/17/2017
# Tech: Matthew Messer
# Email: mmesserlmt@gmail.com
#=========================================================================================
# Purpose: Export computer asset information to the "Misc" sheet in the "PC_Refresh_Asset_Inventory" Excel Workbook
